...
def search_and_generate_response(user_query):
    ...
    prompt_template = ChatPromptTemplate.from_template(template="""Answer the user’s question using the given context. In the context are documents that should contain an answer."
    'Documents:\n{context}\n\nQuestion: {query}'""")
